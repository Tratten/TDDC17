...
public class QLearningController extends Controller {
	...
	final int action_left = 1;
	final int action_middle = 2;
	final int action_right = 3;
	final int action_leftMiddle = 4;
	final int action_rightMiddle = 5;
	final int action_all = 6;
	...
	void performAction(int action) {
		...
		switch (action) {
			case action_none: leftEngine.setBursting(false);
					middleEngine.setBursting(false);
					rightEngine.setBursting(false);
					break;
			case action_left: leftEngine.setBursting(true);
					middleEngine.setBursting(false);
					rightEngine.setBursting(false);
					break;
			case action_middle: leftEngine.setBursting(false);
					middleEngine.setBursting(true);
					rightEngine.setBursting(false);
					break;
			case action_right: leftEngine.setBursting(false);
					middleEngine.setBursting(false);
					rightEngine.setBursting(true);
					break;
			case action_leftMiddle: leftEngine.setBursting(true);
					middleEngine.setBursting(true);
					rightEngine.setBursting(false);
					break;
			case action_rightMiddle: leftEngine.setBursting(false);
					middleEngine.setBursting(true);
					rightEngine.setBursting(true);
					break;
			case action_all: leftEngine.setBursting(true);
					middleEngine.setBursting(true);
					rightEngine.setBursting(true);
					break;
			default:
